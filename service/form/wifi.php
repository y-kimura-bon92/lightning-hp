...
const SPLIT_LAYOUT_FIXED = <<<EOF
  <div class="jumbotron catch_copy">
    <h1 class="display-3">APPLICATION<br><span class="">UNION WI-FI お申し込み</span></h1>
  </div>
EOF;
?>
...
<div class="container mt_120 mb_120 sp_mt_80">
    ...
    <div class="row mt_40">
      <div class="col-lg-6">
        ...
        <p class="img_content_btn text-center box mt_20">
          <a href="<?php echo PDFURL; ?>/union-wifi_ agreement.pdf" class="d-inline-block boxInner" target="blank"><i class="far fa-file-pdf"></i> PDF</a>
        </p>
      </div>
  ...
  <div class="row mt_80">
    ...
    <div class="contact-form mt_20">
      <form role="form" method="post" action="<?php echo SITEURL; ?>/service/application/confirm/uni-wi-fi.php">
        <!-- 名前 -->
