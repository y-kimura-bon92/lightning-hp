...
const SPLIT_LAYOUT_FIXED = <<<EOF
  <div class="jumbotron catch_copy">
    <h1 class="display-3">APPLICATION<br><span class="">クレジットカード保証お申し込み</span></h1>
  </div>
EOF;
?>
...
<div class="container mt_120 mb_120 sp_mt_80">
  ...
  <div class="row mt_80">
    ...
    <div class="contact-form mt_20">
      <form role="form" method="post" action="<?php echo SITEURL; ?>/service/application/confirm/credit.php">
        <!-- 名前 -->
