...
const TITLE = 'UNION クレジットカード保証お申し込み（確認画面）';
const CSS = '
...
<div class="container mt_120 mb_120 sp_mt_80">
  <div class="mb_80">
    <h2 class="first_letter_design">UNION クレジットカード保証お申し込み<br>（確認画面） ―</h2>
  </div>

  <!-- 確認画面送信フォーム -->
  <div class="confirmation mt_40">
    <form action="<?php echo SITEURL; ?>/service/application/complete/credit.php" method="post">
      <table class="table">
        <tr class="row">
