...
const SPLIT_LAYOUT_FIXED = <<<EOF
  <div class="jumbotron catch_copy">
    <h1 class="display-3">APPLICATION<br><span class="">UNION-ISP お申し込み<br>（確認画面）</span></h1>
  </div>
EOF;
...
<div class="container mt_120 mb_120 sp_mt_80">
  <div class="mb_80">
    <h2 class="first_letter_design">UNION-ISP お申し込み<br>（確認画面） ―</h2>
  </div>

  <!-- 確認画面送信フォーム -->
  <div class="confirmation mt_40">
    <form action="<?php echo SITEURL; ?>/service/application/complete/unisp.php" method="post">
      <table class="table">
        <tr class="row">
