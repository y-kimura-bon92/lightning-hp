...
const TITLE = 'UNION クレジットカード保証お申し込み（完了画面）';
const CSS = '
...
const SPLIT_LAYOUT_FIXED = <<<EOF
  <div class="jumbotron catch_copy">
    <h1 class="display-3">APPLICATION<br><span class="">UNION クレジットカード保証 お申し込み<br>（完了画面）</span></h1>
  </div>
EOF;
...
<div class="container mt_120 mb_120 sp_mt_80">
  <div class="mb_80">
    <h2 class="first_letter_design">UNION クレジットカード保証お申し込み<br>（完了画面） ―</h2>
  </div>
