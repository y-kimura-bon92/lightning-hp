    ...
    <div class="split-item split-left">
      <div class="split-left__inner">
        ...
        <div class="jumbotron catch_copy">
          <h1 class="display-3">CONTACT<br><span class="">お問い合わせ（完了画面）</span></h1>
        </div>
      </div>
    </div>
    ...
    <div class="split-item split-right">
      <div class="split-right__inner">
        ...
        <div class="container mt_120 mb_120">
          <div class="mb_80">
            <h2 class="first_letter_design">お問い合わせ（完了画面） ―</h2>
          </div>
          ...
          <div>
            ...
            <div class="btn_area mt_40">
              <p>
                <a href="#" class="btn btn-outline-danger w-25" onClick="history.go(-2); return false;">お問い合わせページへ</a>
